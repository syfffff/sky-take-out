...
//        }
    ...
    @Override
    public PageResult historyOrdersPageQuery4User(int page, int pageSize, Integer status) {
    ...
    @Override
    public PageResult historyOrdersPageQuery4Admin(OrdersPageQueryDTO ordersPageQueryDTO) {
